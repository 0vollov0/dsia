...
var DoubleLinkedList = (function (_super) {
    ...
    DoubleLinkedList.prototype.add = function () {
        if (1 < arguments.length)
            return;
        var node = new DoubleLinkedListNode_1.default(arguments[0]);
    ...
    DoubleLinkedList.prototype.search = function () {
        ...
        else if ((arg[0] instanceof DoubleLinkedListNode_1.default || (!arg[0] && arg.length > 1)) && arg[1] != null) {
            var node = arg[0];
            var data = arg[1];
